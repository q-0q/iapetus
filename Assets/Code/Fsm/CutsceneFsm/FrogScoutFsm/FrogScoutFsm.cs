...
public partial class FrogScoutFsm : CutsceneFsm
{
    public class FrogScoutFsmState : CutsceneFsmState
    {
    ...
    public class FrogScoutFsmTrigger : CutsceneFsm.CutsceneFsmTrigger
    {
    ...
    {
        base.OnStart();
        InitState = FrogScoutFsmState.Idle;
